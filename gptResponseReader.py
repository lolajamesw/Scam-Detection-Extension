...
def get_avg_rent(house, city):
    rent = query({
        "inputs": "What is the average monthly rent of a " + house + " located in "  + city,
        "parameters": {
            "top_p": 0.7,
...
Lease Terms: First and last month’s rent due at signing; tenant insurance required.
